...
main = do
    ...
    print(eval(      Div (Add (Val 1) (Val 7)) (Sub (Val 5) (Val 5)) ))
    print(evalmonad( Div (Add (Val 1) (Val 7)) (Sub (Val 5) (Val 5)) ))
    print(evalfinal( Div (Add (Val 1) (Val 7)) (Sub (Val 5) (Val 5)) ))

    print(eval(      Add (Val 7) (Sub (Mul (Val 8) (Val 7)) (Val 9)) ))
    print(evalmonad( Add (Val 7) (Sub (Mul (Val 8) (Val 7)) (Val 9)) ))
    print(evalfinal( Add (Val 7) (Sub (Mul (Val 8) (Val 7)) (Val 9)) ))
